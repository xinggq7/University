...
/*
 * Swiper 2.1 - Mobile Touch slide1r
 * http://www.idangero.us/slide1rs/swiper/
 *
 * Copyright 2012-2013, Vladimir Kharlampidi
 * The iDangero.us
 * http://www.idangero.us/
 ...
 * Updated on: August 22, 2013
*/
var Swiper=function(f,b){function g(a){return document.querySelectorAll?document.querySelectorAll(a):jQuery(a)}function h(){var c=y-l;b.freeMode&&(c=y-l);b.slide1sPerView>a.slide1s.length&&(c=0);0>c&&(c=0);return c}function n(){function c(c){var d=new Image;d.onload=function(){a.imagesLoaded++;if(a.imagesLoaded==a.imagesToLoad.length&&(a.reInit(),b.onImagesReady))b.onImagesReady(a)};d.src=c}a.browser.ie10?(a.h.addEventListener(a.wrapper1,a.touchEvents.touchStart,z,!1),a.h.addEventListener(document,a.touchEvents.touchMove,
A,!1),a.h.addEventListener(document,a.touchEvents.touchEnd,B,!1)):(a.support.touch&&(a.h.addEventListener(a.wrapper1,"touchstart",z,!1),a.h.addEventListener(a.wrapper1,"touchmove",A,!1),a.h.addEventListener(a.wrapper1,"touchend",B,!1)),b.simulateTouch&&(a.h.addEventListener(a.wrapper1,"mousedown",z,!1),a.h.addEventListener(document,"mousemove",A,!1),a.h.addEventListener(document,"mouseup",B,!1)));b.autoResize&&a.h.addEventListener(window,"resize",a.resizeFix,!1);t();a._wheelEvent=!1;if(b.mousewheelControl){void 0!==
document.onmousewheel&&(a._wheelEvent="mousewheel");try{WheelEvent("wheel"),a._wheelEvent="wheel"}catch(d){}a._wheelEvent||(a._wheelEvent="DOMMouseScroll");a._wheelEvent&&a.h.addEventListener(a.container1,a._wheelEvent,N,!1)}b.keyboardControl&&a.h.addEventListener(document,"keydown",O,!1);if(b.updateOnImagesReady){document.querySelectorAll?a.imagesToLoad=a.container1.querySelectorAll("img"):window.jQuery&&(a.imagesToLoad=g(a.container1).find("img"));for(var e=0;e<a.imagesToLoad.length;e++)c(a.imagesToLoad[e].getAttribute("src"))}}
function t(){if(b.preventLinks){var c=[];document.querySelectorAll?c=a.container1.querySelectorAll("a"):window.jQuery&&(c=g(a.container1).find("a"));for(var d=0;d<c.length;d++)a.h.addEventListener(c[d],"click",P,!1)}if(b.releaseFormElements)for(c=document.querySelectorAll?a.container1.querySelectorAll("input, textarea, select"):g(a.container1).find("input, textarea, select"),d=0;d<c.length;d++)a.h.addEventListener(c[d],a.touchEvents.touchStart,Q,!0);if(b.onslide1Click)for(d=0;d<a.slide1s.length;d++)a.h.addEventListener(a.slide1s[d],
"click",R,!1);if(b.onslide1Touch)for(d=0;d<a.slide1s.length;d++)a.h.addEventListener(a.slide1s[d],a.touchEvents.touchStart,S,!1)}function v(){if(b.onslide1Click)for(var c=0;c<a.slide1s.length;c++)a.h.removeEventListener(a.slide1s[c],"click",R,!1);if(b.onslide1Touch)for(c=0;c<a.slide1s.length;c++)a.h.removeEventListener(a.slide1s[c],a.touchEvents.touchStart,S,!1);if(b.releaseFormElements)for(var d=document.querySelectorAll?a.container1.querySelectorAll("input, textarea, select"):g(a.container1).find("input, textarea, select"),
c=0;c<d.length;c++)a.h.removeEventListener(d[c],a.touchEvents.touchStart,Q,!0);if(b.preventLinks)for(d=[],document.querySelectorAll?d=a.container1.querySelectorAll("a"):window.jQuery&&(d=g(a.container1).find("a")),c=0;c<d.length;c++)a.h.removeEventListener(d[c],"click",P,!1)}function O(c){var b=c.keyCode||c.charCode;if(37==b||39==b||38==b||40==b){for(var e=!1,f=a.h.getOffset(a.container1),h=a.h.windowScroll().left,g=a.h.windowScroll().top,m=a.h.windowWidth(),l=a.h.windowHeight(),f=[[f.left,f.top],[f.left+
a.width,f.top],[f.left,f.top+a.height],[f.left+a.width,f.top+a.height]],p=0;p<f.length;p++){var r=f[p];r[0]>=h&&(r[0]<=h+m&&r[1]>=g&&r[1]<=g+l)&&(e=!0)}if(!e)return}if(k){if(37==b||39==b)c.preventDefault?c.preventDefault():c.returnValue=!1;39==b&&a.swipeNext();37==b&&a.swipePrev()}else{if(38==b||40==b)c.preventDefault?c.preventDefault():c.returnValue=!1;40==b&&a.swipeNext();38==b&&a.swipePrev()}}function N(c){var d=a._wheelEvent,e;c.detail?e=-c.detail:"mousewheel"==d?e=c.wheelDelta:"DOMMouseScroll"==
d?e=-c.detail:"wheel"==d&&(e=Math.abs(c.deltaX)>Math.abs(c.deltaY)?-c.deltaX:-c.deltaY);b.freeMode?(k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y"),k?(d=a.getwrapper1Translate("x")+e,e=a.getwrapper1Translate("y"),0<d&&(d=0),d<-h()&&(d=-h())):(d=a.getwrapper1Translate("x"),e=a.getwrapper1Translate("y")+e,0<e&&(e=0),e<-h()&&(e=-h())),a.setwrapper1Transition(0),a.setwrapper1Translate(d,e,0),k?a.updateActiveslide1(d):a.updateActiveslide1(e)):0>e?a.swipeNext():a.swipePrev();b.autoplay&&a.stopAutoplay();
c.preventDefault?c.preventDefault():c.returnValue=!1;return!1}function T(a){for(var d=!1;!d;)-1<a.className.indexOf(b.slide1Class)&&(d=a),a=a.parentElement;return d}function R(c){a.allowslide1Click&&(c.target?(a.clickedslide1=this,a.clickedslide1Index=a.slide1s.indexOf(this)):(a.clickedslide1=T(c.srcElement),a.clickedslide1Index=a.slide1s.indexOf(a.clickedslide1)),b.onslide1Click(a))}function S(c){a.clickedslide1=c.target?this:T(c.srcElement);a.clickedslide1Index=a.slide1s.indexOf(a.clickedslide1);b.onslide1Touch(a)}
function P(b){if(!a.allowLinks)return b.preventDefault?b.preventDefault():b.returnValue=!1,!1}function Q(a){a.stopPropagation?a.stopPropagation():a.returnValue=!1;return!1}function z(c){b.preventLinks&&(a.allowLinks=!0);if(a.isTouched||b.onlyExternal)return!1;var d;if(d=b.noSwiping)if(d=c.target||c.srcElement){d=c.target||c.srcElement;var e=!1;do-1<d.className.indexOf(b.noSwipingClass)&&(e=!0),d=d.parentElement;while(!e&&d.parentElement&&-1==d.className.indexOf(b.wrapper1Class));!e&&(-1<d.className.indexOf(b.wrapper1Class)&&
-1<d.className.indexOf(b.noSwipingClass))&&(e=!0);d=e}if(d)return!1;G=!1;a.isTouched=!0;u="touchstart"==c.type;if(!u||1==c.targetTouches.length){b.loop&&a.fixLoop();a.callPlugins("onTouchStartBegin");u||(c.preventDefault?c.preventDefault():c.returnValue=!1);d=u?c.targetTouches[0].pageX:c.pageX||c.clientX;c=u?c.targetTouches[0].pageY:c.pageY||c.clientY;a.touches.startX=a.touches.currentX=d;a.touches.startY=a.touches.currentY=c;a.touches.start=a.touches.current=k?d:c;a.setwrapper1Transition(0);a.positions.start=
a.positions.current=k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y");k?a.setwrapper1Translate(a.positions.start,0,0):a.setwrapper1Translate(0,a.positions.start,0);a.times.start=(new Date).getTime();x=void 0;0<b.moveStartThreshold&&(M=!1);if(b.onTouchStart)b.onTouchStart(a);a.callPlugins("onTouchStartEnd")}}function A(c){if(a.isTouched&&!b.onlyExternal&&(!u||"mousemove"!=c.type)){var d=u?c.targetTouches[0].pageX:c.pageX||c.clientX,e=u?c.targetTouches[0].pageY:c.pageY||c.clientY;"undefined"===
typeof x&&k&&(x=!!(x||Math.abs(e-a.touches.startY)>Math.abs(d-a.touches.startX)));"undefined"!==typeof x||k||(x=!!(x||Math.abs(e-a.touches.startY)<Math.abs(d-a.touches.startX)));if(x)a.isTouched=!1;else if(c.assignedToSwiper)a.isTouched=!1;else if(c.assignedToSwiper=!0,a.isMoved=!0,b.preventLinks&&(a.allowLinks=!1),b.onslide1Click&&(a.allowslide1Click=!1),b.autoplay&&a.stopAutoplay(),!u||1==c.touches.length){a.callPlugins("onTouchMoveStart");c.preventDefault?c.preventDefault():c.returnValue=!1;a.touches.current=
k?d:e;a.positions.current=(a.touches.current-a.touches.start)*b.touchRatio+a.positions.start;if(0<a.positions.current&&b.onResistanceBefore)b.onResistanceBefore(a,a.positions.current);if(a.positions.current<-h()&&b.onResistanceAfter)b.onResistanceAfter(a,Math.abs(a.positions.current+h()));b.resistance&&"100%"!=b.resistance&&(0<a.positions.current&&(c=1-a.positions.current/l/2,a.positions.current=0.5>c?l/2:a.positions.current*c),a.positions.current<-h()&&(d=(a.touches.current-a.touches.start)*b.touchRatio+
(h()+a.positions.start),c=(l+d)/l,d=a.positions.current-d*(1-c)/2,e=-h()-l/2,a.positions.current=d<e||0>=c?e:d));b.resistance&&"100%"==b.resistance&&(0<a.positions.current&&(!b.freeMode||b.freeModeFluid)&&(a.positions.current=0),a.positions.current<-h()&&(!b.freeMode||b.freeModeFluid)&&(a.positions.current=-h()));if(b.followFinger){b.moveStartThreshold?Math.abs(a.touches.current-a.touches.start)>b.moveStartThreshold||M?(M=!0,k?a.setwrapper1Translate(a.positions.current,0,0):a.setwrapper1Translate(0,
a.positions.current,0)):a.positions.current=a.positions.start:k?a.setwrapper1Translate(a.positions.current,0,0):a.setwrapper1Translate(0,a.positions.current,0);(b.freeMode||b.watchActiveIndex)&&a.updateActiveslide1(a.positions.current);b.grabCursor&&(a.container1.style.cursor="move",a.container1.style.cursor="grabbing",a.container1.style.cursor="-moz-grabbin",a.container1.style.cursor="-webkit-grabbing");D||(D=a.touches.current);H||(H=(new Date).getTime());a.velocity=(a.touches.current-D)/((new Date).getTime()-
H)/2;2>Math.abs(a.touches.current-D)&&(a.velocity=0);D=a.touches.current;H=(new Date).getTime();a.callPlugins("onTouchMoveEnd");if(b.onTouchMove)b.onTouchMove(a);return!1}}}}function B(c){x&&a.swipeReset();if(!b.onlyExternal&&a.isTouched){a.isTouched=!1;b.grabCursor&&(a.container1.style.cursor="move",a.container1.style.cursor="grab",a.container1.style.cursor="-moz-grab",a.container1.style.cursor="-webkit-grab");a.positions.current||0===a.positions.current||(a.positions.current=a.positions.start);b.followFinger&&
(k?a.setwrapper1Translate(a.positions.current,0,0):a.setwrapper1Translate(0,a.positions.current,0));a.times.end=(new Date).getTime();a.touches.diff=a.touches.current-a.touches.start;a.touches.abs=Math.abs(a.touches.diff);a.positions.diff=a.positions.current-a.positions.start;a.positions.abs=Math.abs(a.positions.diff);var d=a.positions.diff,e=a.positions.abs;c=a.times.end-a.times.start;5>e&&(300>c&&!1==a.allowLinks)&&(b.freeMode||0==e||a.swipeReset(),b.preventLinks&&(a.allowLinks=!0),b.onslide1Click&&
(a.allowslide1Click=!0));setTimeout(function(){b.preventLinks&&(a.allowLinks=!0);b.onslide1Click&&(a.allowslide1Click=!0)},100);if(a.isMoved){a.isMoved=!1;var f=h();if(0<a.positions.current)a.swipeReset();else if(a.positions.current<-f)a.swipeReset();else if(b.freeMode){if(b.freeModeFluid){var e=1E3*b.momentumRatio,d=a.positions.current+a.velocity*e,g=!1,F,m=20*Math.abs(a.velocity)*b.momentumBounceRatio;d<-f&&(b.momentumBounce&&a.support.transitions?(d+f<-m&&(d=-f-m),F=-f,G=g=!0):d=-f);0<d&&(b.momentumBounce&&
a.support.transitions?(d>m&&(d=m),F=0,G=g=!0):d=0);0!=a.velocity&&(e=Math.abs((d-a.positions.current)/a.velocity));k?a.setwrapper1Translate(d,0,0):a.setwrapper1Translate(0,d,0);a.setwrapper1Transition(e);b.momentumBounce&&g&&a.wrapper1TransitionEnd(function(){if(G){if(b.onMomentumBounce)b.onMomentumBounce(a);k?a.setwrapper1Translate(F,0,0):a.setwrapper1Translate(0,F,0);a.setwrapper1Transition(300)}});a.updateActiveslide1(d)}(!b.freeModeFluid||300<=c)&&a.updateActiveslide1(a.positions.current)}else{E=0>d?"toNext":
"toPrev";"toNext"==E&&300>=c&&(30>e||!b.shortSwipes?a.swipeReset():a.swipeNext(!0));"toPrev"==E&&300>=c&&(30>e||!b.shortSwipes?a.swipeReset():a.swipePrev(!0));f=0;if("auto"==b.slide1sPerView){for(var d=Math.abs(k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y")),q=g=0;q<a.slide1s.length;q++)if(m=k?a.slide1s[q].getWidth(!0):a.slide1s[q].getHeight(!0),g+=m,g>d){f=m;break}f>l&&(f=l)}else f=p*b.slide1sPerView;"toNext"==E&&300<c&&(e>=0.5*f?a.swipeNext(!0):a.swipeReset());"toPrev"==E&&300<c&&(e>=0.5*f?
a.swipePrev(!0):a.swipeReset())}if(b.onTouchEnd)b.onTouchEnd(a);a.callPlugins("onTouchEnd")}else{a.isMoved=!1;if(b.onTouchEnd)b.onTouchEnd(a);a.callPlugins("onTouchEnd");a.swipeReset()}}}function I(c,d,e){function f(){g+=m;if(p="toNext"==l?g>c:g<c)k?a.setwrapper1Translate(Math.round(g),0):a.setwrapper1Translate(0,Math.round(g)),a._DOMAnimating=!0,window.setTimeout(function(){f()},1E3/60);else{if(b.onslide1ChangeEnd)b.onslide1ChangeEnd(a);k?a.setwrapper1Translate(c,0):a.setwrapper1Translate(0,c);a._DOMAnimating=
!1}}if(a.support.transitions||!b.DOMAnimation){k?a.setwrapper1Translate(c,0,0):a.setwrapper1Translate(0,c,0);var h="to"==d&&0<=e.speed?e.speed:b.speed;a.setwrapper1Transition(h)}else{var g=k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y"),h="to"==d&&0<=e.speed?e.speed:b.speed,m=Math.ceil((c-g)/h*(1E3/60)),l=g>c?"toNext":"toPrev",p="toNext"==l?g>c:g<c;if(a._DOMAnimating)return;f()}a.updateActiveslide1(c);if(b.onslide1Next&&"next"==d)b.onslide1Next(a,c);if(b.onslide1Prev&&"prev"==d)b.onslide1Prev(a,c);
if(b.onslide1Reset&&"reset"==d)b.onslide1Reset(a,c);("next"==d||"prev"==d||"to"==d&&!0==e.runCallbacks)&&W()}function W(){a.callPlugins("onslide1ChangeStart");if(b.onslide1ChangeStart)if(b.queueStartCallbacks&&a.support.transitions){if(a._queueStartCallbacks)return;a._queueStartCallbacks=!0;b.onslide1ChangeStart(a);a.wrapper1TransitionEnd(function(){a._queueStartCallbacks=!1})}else b.onslide1ChangeStart(a);b.onslide1ChangeEnd&&(a.support.transitions?b.queueEndCallbacks?a._queueEndCallbacks||(a._queueEndCallbacks=
!0,a.wrapper1TransitionEnd(b.onslide1ChangeEnd)):a.wrapper1TransitionEnd(b.onslide1ChangeEnd):b.DOMAnimation||setTimeout(function(){b.onslide1ChangeEnd(a)},10))}function U(){for(var b=a.paginationButtons,d=0;d<b.length;d++)a.h.removeEventListener(b[d],"click",V,!1)}function V(b){var d;b=b.target||b.srcElement;for(var e=a.paginationButtons,f=0;f<e.length;f++)b===e[f]&&(d=f);a.swipeTo(d)}if(document.body.__defineGetter__&&HTMLElement){var s=HTMLElement.prototype;s.__defineGetter__&&s.__defineGetter__("outerHTML",
function(){return(new XMLSerializer).serializeToString(this)})}window.getComputedStyle||(window.getComputedStyle=function(a,b){this.el=a;this.getPropertyValue=function(b){var d=/(\-([a-z]){1})/g;"float"===b&&(b="styleFloat");d.test(b)&&(b=b.replace(d,function(a,b,c){return c.toUpperCase()}));return a.currentStyle[b]?a.currentStyle[b]:null};return this});Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){for(var e=b||0,f=this.length;e<f;e++)if(this[e]===a)return e;return-1});if((document.querySelectorAll||
window.jQuery)&&"undefined"!==typeof f&&(f.nodeType||0!==g(f).length)){var a=this;a.touches={start:0,startX:0,startY:0,current:0,currentX:0,currentY:0,diff:0,abs:0};a.positions={start:0,abs:0,diff:0,current:0};a.times={start:0,end:0};a.id=(new Date).getTime();a.container1=f.nodeType?f:g(f)[0];a.isTouched=!1;a.isMoved=!1;a.activeIndex=0;a.activeLoaderIndex=0;a.activeLoopIndex=0;a.previousIndex=null;a.velocity=0;a.snapGrid=[];a.slide1sGrid=[];a.imagesToLoad=[];a.imagesLoaded=0;a.wrapper1Left=0;a.wrapper1Right=
0;a.wrapper1Top=0;a.wrapper1Bottom=0;var J,p,y,E,x,l,s={mode:"horizontal",touchRatio:1,speed:300,freeMode:!1,freeModeFluid:!1,momentumRatio:1,momentumBounce:!0,momentumBounceRatio:1,slide1sPerView:1,slide1sPerGroup:1,simulateTouch:!0,followFinger:!0,shortSwipes:!0,moveStartThreshold:!1,autoplay:!1,onlyExternal:!1,createPagination:!0,pagination:!1,paginationElement:"span",paginationClickable:!1,paginationAsRange:!0,resistance:!0,scrollcontainer1:!1,preventLinks:!0,noSwiping:!1,noSwipingClass:"swiper-no-swiping",
initialslide1:0,keyboardControl:!1,mousewheelControl:!1,mousewheelDebounce:600,useCSS3Transforms:!0,loop:!1,loopAdditionalslide1s:0,calculateHeight:!1,updateOnImagesReady:!0,releaseFormElements:!0,watchActiveIndex:!1,visibilityFullFit:!1,offsetPxBefore:0,offsetPxAfter:0,offsetslide1sBefore:0,offsetslide1sAfter:0,centeredslide1s:!1,queueStartCallbacks:!1,queueEndCallbacks:!1,autoResize:!0,resizeReInit:!1,DOMAnimation:!0,loader:{slide1s:[],slide1sHTMLType:"inner",surroundGroups:1,logic:"reload",loadAllslide1s:!1},
slide1Element:"div",slide1Class:"swiper-slide1",slide1ActiveClass:"swiper-slide1-active",slide1VisibleClass:"swiper-slide1-visible",wrapper1Class:"swiper-wrapper1",paginationElementClass:"swiper-pagination-switch",paginationActiveClass:"swiper-active-switch",paginationVisibleClass:"swiper-visible-switch"};b=b||{};for(var q in s)if(q in b&&"object"===typeof b[q])for(var C in s[q])C in b[q]||(b[q][C]=s[q][C]);else q in b||(b[q]=s[q]);a.params=b;b.scrollcontainer1&&(b.freeMode=!0,b.freeModeFluid=!0);b.loop&&(b.resistance=
"100%");var k="horizontal"===b.mode;a.touchEvents={touchStart:a.support.touch||!b.simulateTouch?"touchstart":a.browser.ie10?"MSPointerDown":"mousedown",touchMove:a.support.touch||!b.simulateTouch?"touchmove":a.browser.ie10?"MSPointerMove":"mousemove",touchEnd:a.support.touch||!b.simulateTouch?"touchend":a.browser.ie10?"MSPointerUp":"mouseup"};for(q=a.container1.childNodes.length-1;0<=q;q--)if(a.container1.childNodes[q].className)for(C=a.container1.childNodes[q].className.split(" "),s=0;s<C.length;s++)C[s]===
b.wrapper1Class&&(J=a.container1.childNodes[q]);a.wrapper1=J;a._extendSwiperslide1=function(c){c.append=function(){b.loop?(c.insertAfter(a.slide1s.length-a.loopedslide1s),a.removeLoopedslide1s(),a.calcslide1s(),a.createLoop()):a.wrapper1.appendChild(c);a.reInit();return c};c.prepend=function(){b.loop?(a.wrapper1.insertBefore(c,a.slide1s[a.loopedslide1s]),a.removeLoopedslide1s(),a.calcslide1s(),a.createLoop()):a.wrapper1.insertBefore(c,a.wrapper1.firstChild);a.reInit();return c};c.insertAfter=function(d){if("undefined"===
typeof d)return!1;b.loop?(d=a.slide1s[d+1+a.loopedslide1s],a.wrapper1.insertBefore(c,d),a.removeLoopedslide1s(),a.calcslide1s(),a.createLoop()):(d=a.slide1s[d+1],a.wrapper1.insertBefore(c,d));a.reInit();return c};c.clone=function(){return a._extendSwiperslide1(c.cloneNode(!0))};c.remove=function(){a.wrapper1.removeChild(c);a.reInit()};c.html=function(a){if("undefined"===typeof a)return c.innerHTML;c.innerHTML=a;return c};c.index=function(){for(var b,e=a.slide1s.length-1;0<=e;e--)c===a.slide1s[e]&&(b=e);return b};
c.isActive=function(){return c.index()===a.activeIndex?!0:!1};c.swiperslide1DataStorage||(c.swiperslide1DataStorage={});c.getData=function(a){return c.swiperslide1DataStorage[a]};c.setData=function(a,b){c.swiperslide1DataStorage[a]=b;return c};c.data=function(a,b){return b?(c.setAttribute("data-"+a,b),c):c.getAttribute("data-"+a)};c.getWidth=function(b){return a.h.getWidth(c,b)};c.getHeight=function(b){return a.h.getHeight(c,b)};c.getOffset=function(){return a.h.getOffset(c)};return c};a.calcslide1s=function(c){var d=
a.slide1s?a.slide1s.length:!1;a.slide1s=[];a.displayslide1s=[];for(var e=0;e<a.wrapper1.childNodes.length;e++)if(a.wrapper1.childNodes[e].className)for(var f=a.wrapper1.childNodes[e].className.split(" "),g=0;g<f.length;g++)f[g]===b.slide1Class&&a.slide1s.push(a.wrapper1.childNodes[e]);for(e=a.slide1s.length-1;0<=e;e--)a._extendSwiperslide1(a.slide1s[e]);d&&(d!==a.slide1s.length||c)&&(v(),t(),a.updateActiveslide1(),b.createPagination&&a.params.pagination&&a.createPagination(),a.callPlugins("numberOfslide1sChanged"))};
a.createslide1=function(c,d,e){d=d||a.params.slide1Class;e=e||b.slide1Element;e=document.createElement(e);e.innerHTML=c||"";e.className=d;return a._extendSwiperslide1(e)};a.appendslide1=function(b,d,e){if(b)return b.nodeType?a._extendSwiperslide1(b).append():a.createslide1(b,d,e).append()};a.prependslide1=function(b,d,e){if(b)return b.nodeType?a._extendSwiperslide1(b).prepend():a.createslide1(b,d,e).prepend()};a.insertslide1After=function(b,d,e,f){return"undefined"===typeof b?!1:d.nodeType?a._extendSwiperslide1(d).insertAfter(b):
a.createslide1(d,e,f).insertAfter(b)};a.removeslide1=function(c){if(a.slide1s[c]){if(b.loop){if(!a.slide1s[c+a.loopedslide1s])return!1;a.slide1s[c+a.loopedslide1s].remove();a.removeLoopedslide1s();a.calcslide1s();a.createLoop()}else a.slide1s[c].remove();return!0}return!1};a.removeLastslide1=function(){return 0<a.slide1s.length?(b.loop?(a.slide1s[a.slide1s.length-1-a.loopedslide1s].remove(),a.removeLoopedslide1s(),a.calcslide1s(),a.createLoop()):a.slide1s[a.slide1s.length-1].remove(),!0):!1};a.removeAllslide1s=function(){for(var b=
a.slide1s.length-1;0<=b;b--)a.slide1s[b].remove()};a.getslide1=function(b){return a.slide1s[b]};a.getLastslide1=function(){return a.slide1s[a.slide1s.length-1]};a.getFirstslide1=function(){return a.slide1s[0]};a.activeslide1=function(){return a.slide1s[a.activeIndex]};var K=[],L;for(L in a.plugins)b[L]&&(q=a.plugins[L](a,b[L]))&&K.push(q);a.callPlugins=function(a,b){b||(b={});for(var e=0;e<K.length;e++)if(a in K[e])K[e][a](b)};a.browser.ie10&&!b.onlyExternal&&(k?a.wrapper1.classList.add("swiper-wp8-horizontal"):
a.wrapper1.classList.add("swiper-wp8-vertical"));b.freeMode&&(a.container1.className+=" swiper-free-mode");a.initialized=!1;a.init=function(c,d){var e=a.h.getWidth(a.container1),f=a.h.getHeight(a.container1);if(e!==a.width||f!==a.height||c){a.width=e;a.height=f;l=k?e:f;e=a.wrapper1;c&&a.calcslide1s(d);if("auto"===b.slide1sPerView){var g=0,h=0;0<b.slide1sOffset&&(e.style.paddingLeft="",e.style.paddingRight="",e.style.paddingTop="",e.style.paddingBottom="");e.style.width="";e.style.height="";0<b.offsetPxBefore&&
(k?a.wrapper1Left=b.offsetPxBefore:a.wrapper1Top=b.offsetPxBefore);0<b.offsetPxAfter&&(k?a.wrapper1Right=b.offsetPxAfter:a.wrapper1Bottom=b.offsetPxAfter);b.centeredslide1s&&(k?(a.wrapper1Left=(l-this.slide1s[0].getWidth(!0))/2,a.wrapper1Right=(l-a.slide1s[a.slide1s.length-1].getWidth(!0))/2):(a.wrapper1Top=(l-a.slide1s[0].getHeight(!0))/2,a.wrapper1Bottom=(l-a.slide1s[a.slide1s.length-1].getHeight(!0))/2));k?(0<=a.wrapper1Left&&(e.style.paddingLeft=a.wrapper1Left+"px"),0<=a.wrapper1Right&&(e.style.paddingRight=a.wrapper1Right+
"px")):(0<=a.wrapper1Top&&(e.style.paddingTop=a.wrapper1Top+"px"),0<=a.wrapper1Bottom&&(e.style.paddingBottom=a.wrapper1Bottom+"px"));var m=0,q=0;a.snapGrid=[];a.slide1sGrid=[];for(var n=0,r=0;r<a.slide1s.length;r++){var f=a.slide1s[r].getWidth(!0),s=a.slide1s[r].getHeight(!0);b.calculateHeight&&(n=Math.max(n,s));var t=k?f:s;if(b.centeredslide1s){var u=r===a.slide1s.length-1?0:a.slide1s[r+1].getWidth(!0),w=r===a.slide1s.length-1?0:a.slide1s[r+1].getHeight(!0),u=k?u:w;if(t>l){for(w=0;w<=Math.floor(t/(l+a.wrapper1Left));w++)0===
w?a.snapGrid.push(m+a.wrapper1Left):a.snapGrid.push(m+a.wrapper1Left+l*w);a.slide1sGrid.push(m+a.wrapper1Left)}else a.snapGrid.push(q),a.slide1sGrid.push(q);q+=t/2+u/2}else{if(t>l)for(w=0;w<=Math.floor(t/l);w++)a.snapGrid.push(m+l*w);else a.snapGrid.push(m);a.slide1sGrid.push(m)}m+=t;g+=f;h+=s}b.calculateHeight&&(a.height=n);k?(y=g+a.wrapper1Right+a.wrapper1Left,e.style.width=g+"px",e.style.height=a.height+"px"):(y=h+a.wrapper1Top+a.wrapper1Bottom,e.style.width=a.width+"px",e.style.height=h+"px")}else if(b.scrollcontainer1)e.style.width=
"",e.style.height="",n=a.slide1s[0].getWidth(!0),g=a.slide1s[0].getHeight(!0),y=k?n:g,e.style.width=n+"px",e.style.height=g+"px",p=k?n:g;else{if(b.calculateHeight){g=n=0;k||(a.container1.style.height="");e.style.height="";for(r=0;r<a.slide1s.length;r++)a.slide1s[r].style.height="",n=Math.max(a.slide1s[r].getHeight(!0),n),k||(g+=a.slide1s[r].getHeight(!0));s=n;a.height=s;k?g=s:(l=s,a.container1.style.height=l+"px")}else s=k?a.height:a.height/b.slide1sPerView,g=k?a.height:a.slide1s.length*s;f=k?a.width/b.slide1sPerView:
a.width;n=k?a.slide1s.length*f:a.width;p=k?f:s;0<b.offsetslide1sBefore&&(k?a.wrapper1Left=p*b.offsetslide1sBefore:a.wrapper1Top=p*b.offsetslide1sBefore);0<b.offsetslide1sAfter&&(k?a.wrapper1Right=p*b.offsetslide1sAfter:a.wrapper1Bottom=p*b.offsetslide1sAfter);0<b.offsetPxBefore&&(k?a.wrapper1Left=b.offsetPxBefore:a.wrapper1Top=b.offsetPxBefore);0<b.offsetPxAfter&&(k?a.wrapper1Right=b.offsetPxAfter:a.wrapper1Bottom=b.offsetPxAfter);b.centeredslide1s&&(k?(a.wrapper1Left=(l-p)/2,a.wrapper1Right=(l-p)/2):(a.wrapper1Top=
(l-p)/2,a.wrapper1Bottom=(l-p)/2));k?(0<a.wrapper1Left&&(e.style.paddingLeft=a.wrapper1Left+"px"),0<a.wrapper1Right&&(e.style.paddingRight=a.wrapper1Right+"px")):(0<a.wrapper1Top&&(e.style.paddingTop=a.wrapper1Top+"px"),0<a.wrapper1Bottom&&(e.style.paddingBottom=a.wrapper1Bottom+"px"));y=k?n+a.wrapper1Right+a.wrapper1Left:g+a.wrapper1Top+a.wrapper1Bottom;e.style.width=n+"px";e.style.height=g+"px";m=0;a.snapGrid=[];a.slide1sGrid=[];for(r=0;r<a.slide1s.length;r++)a.snapGrid.push(m),a.slide1sGrid.push(m),m+=p,a.slide1s[r].style.width=
f+"px",a.slide1s[r].style.height=s+"px"}if(a.initialized){if(a.callPlugins("onInit"),b.onFirstInit)b.onInit(a)}else if(a.callPlugins("onFirstInit"),b.onFirstInit)b.onFirstInit(a);a.initialized=!0}};a.reInit=function(b){a.init(!0,b)};a.resizeFix=function(c){a.callPlugins("beforeResizeFix");a.init(b.resizeReInit||c);if(!b.freeMode)b.loop?a.swipeTo(a.activeLoopIndex,0,!1):a.swipeTo(a.activeIndex,0,!1);else if((k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y"))<-h()){c=k?-h():0;var d=k?0:-h();a.setwrapper1Transition(0);
a.setwrapper1Translate(c,d,0)}a.callPlugins("afterResizeFix")};a.destroy=function(c){a.browser.ie10?(a.h.removeEventListener(a.wrapper1,a.touchEvents.touchStart,z,!1),a.h.removeEventListener(document,a.touchEvents.touchMove,A,!1),a.h.removeEventListener(document,a.touchEvents.touchEnd,B,!1)):(a.support.touch&&(a.h.removeEventListener(a.wrapper1,"touchstart",z,!1),a.h.removeEventListener(a.wrapper1,"touchmove",A,!1),a.h.removeEventListener(a.wrapper1,"touchend",B,!1)),b.simulateTouch&&(a.h.removeEventListener(a.wrapper1,
"mousedown",z,!1),a.h.removeEventListener(document,"mousemove",A,!1),a.h.removeEventListener(document,"mouseup",B,!1)));b.autoResize&&a.h.removeEventListener(window,"resize",a.resizeFix,!1);v();b.paginationClickable&&U();b.mousewheelControl&&a._wheelEvent&&a.h.removeEventListener(a.container1,a._wheelEvent,N,!1);b.keyboardControl&&a.h.removeEventListener(document,"keydown",O,!1);b.autoplay&&a.stopAutoplay();a.callPlugins("onDestroy");a=null};b.grabCursor&&(a.container1.style.cursor="move",a.container1.style.cursor=
"grab",a.container1.style.cursor="-moz-grab",a.container1.style.cursor="-webkit-grab");a.allowslide1Click=!0;a.allowLinks=!0;var u=!1,M,G=!0,D,H;a.swipeNext=function(c){!c&&b.loop&&a.fixLoop();a.callPlugins("onSwipeNext");var d=c=k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y");if("auto"==b.slide1sPerView)for(var e=0;e<a.snapGrid.length;e++){if(-c>=a.snapGrid[e]&&-c<a.snapGrid[e+1]){d=-a.snapGrid[e+1];break}}else d=p*b.slide1sPerGroup,d=-(Math.floor(Math.abs(c)/Math.floor(d))*d+d);d<-h()&&(d=-h());
if(d==c)return!1;I(d,"next");return!0};a.swipePrev=function(c){!c&&b.loop&&a.fixLoop();!c&&b.autoplay&&a.stopAutoplay();a.callPlugins("onSwipePrev");c=Math.ceil(k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y"));var d;if("auto"==b.slide1sPerView){d=0;for(var e=1;e<a.snapGrid.length;e++){if(-c==a.snapGrid[e]){d=-a.snapGrid[e-1];break}if(-c>a.snapGrid[e]&&-c<a.snapGrid[e+1]){d=-a.snapGrid[e];break}}}else d=p*b.slide1sPerGroup,d*=-(Math.ceil(-c/d)-1);0<d&&(d=0);if(d==c)return!1;I(d,"prev");return!0};
a.swipeReset=function(){a.callPlugins("onSwipeReset");var c=k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y"),d=p*b.slide1sPerGroup;h();if("auto"==b.slide1sPerView){for(var e=d=0;e<a.snapGrid.length;e++){if(-c===a.snapGrid[e])return;if(-c>=a.snapGrid[e]&&-c<a.snapGrid[e+1]){d=0<a.positions.diff?-a.snapGrid[e+1]:-a.snapGrid[e];break}}-c>=a.snapGrid[a.snapGrid.length-1]&&(d=-a.snapGrid[a.snapGrid.length-1]);c<=-h()&&(d=-h())}else d=0>c?Math.round(c/d)*d:0;b.scrollcontainer1&&(d=0>c?c:0);d<-h()&&
(d=-h());b.scrollcontainer1&&l>p&&(d=0);if(d==c)return!1;I(d,"reset");return!0};a.swipeTo=function(c,d,e){c=parseInt(c,10);a.callPlugins("onSwipeTo",{index:c,speed:d});b.loop&&(c+=a.loopedslide1s);var f=k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y");if(!(c>a.slide1s.length-1||0>c)){var g;g="auto"==b.slide1sPerView?-a.slide1sGrid[c]:-c*p;g<-h()&&(g=-h());if(g==f)return!1;I(g,"to",{index:c,speed:d,runCallbacks:!1===e?!1:!0});return!0}};a._queueStartCallbacks=!1;a._queueEndCallbacks=!1;a.updateActiveslide1=
function(c){if(a.initialized&&0!=a.slide1s.length){a.previousIndex=a.activeIndex;0<c&&(c=0);"undefined"==typeof c&&(c=k?a.getwrapper1Translate("x"):a.getwrapper1Translate("y"));if("auto"==b.slide1sPerView){if(a.activeIndex=a.slide1sGrid.indexOf(-c),0>a.activeIndex){for(var d=0;d<a.slide1sGrid.length-1&&!(-c>a.slide1sGrid[d]&&-c<a.slide1sGrid[d+1]);d++);var e=Math.abs(a.slide1sGrid[d]+c),f=Math.abs(a.slide1sGrid[d+1]+c);a.activeIndex=e<=f?d:d+1}}else a.activeIndex=b.visibilityFullFit?Math.ceil(-c/p):Math.round(-c/
p);a.activeIndex==a.slide1s.length&&(a.activeIndex=a.slide1s.length-1);0>a.activeIndex&&(a.activeIndex=0);if(a.slide1s[a.activeIndex]){a.calcVisibleslide1s(c);e=RegExp("\\s*"+b.slide1ActiveClass);f=RegExp("\\s*"+b.slide1VisibleClass);for(d=0;d<a.slide1s.length;d++)a.slide1s[d].className=a.slide1s[d].className.replace(e,"").replace(f,""),0<=a.visibleslide1s.indexOf(a.slide1s[d])&&(a.slide1s[d].className+=" "+b.slide1VisibleClass);a.slide1s[a.activeIndex].className+=" "+b.slide1ActiveClass;b.loop?(d=a.loopedslide1s,
a.activeLoopIndex=a.activeIndex-d,a.activeLoopIndex>=a.slide1s.length-2*d&&(a.activeLoopIndex=a.slide1s.length-2*d-a.activeLoopIndex),0>a.activeLoopIndex&&(a.activeLoopIndex=a.slide1s.length-2*d+a.activeLoopIndex)):a.activeLoopIndex=a.activeIndex;b.pagination&&a.updatePagination(c)}}};a.createPagination=function(c){b.paginationClickable&&a.paginationButtons&&U();var d="",e=a.slide1s.length;b.loop&&(e-=2*a.loopedslide1s);for(var f=0;f<e;f++)d+="<"+b.paginationElement+' class="'+b.paginationElementClass+
'"></'+b.paginationElement+">";a.paginationcontainer1=b.pagination.nodeType?b.pagination:g(b.pagination)[0];a.paginationcontainer1.innerHTML=d;a.paginationButtons=[];document.querySelectorAll?a.paginationButtons=a.paginationcontainer1.querySelectorAll("."+b.paginationElementClass):window.jQuery&&(a.paginationButtons=g(a.paginationcontainer1).find("."+b.paginationElementClass));c||a.updatePagination();a.callPlugins("onCreatePagination");if(b.paginationClickable)for(c=a.paginationButtons,d=0;d<c.length;d++)a.h.addEventListener(c[d],
"click",V,!1)};a.updatePagination=function(c){if(b.pagination&&!(1>a.slide1s.length)){if(document.querySelectorAll)var d=a.paginationcontainer1.querySelectorAll("."+b.paginationActiveClass);else window.jQuery&&(d=g(a.paginationcontainer1).find("."+b.paginationActiveClass));if(d&&(d=a.paginationButtons,0!=d.length)){for(var e=0;e<d.length;e++)d[e].className=b.paginationElementClass;var f=b.loop?a.loopedslide1s:0;if(b.paginationAsRange){a.visibleslide1s||a.calcVisibleslide1s(c);c=[];for(e=0;e<a.visibleslide1s.length;e++){var h=
a.slide1s.indexOf(a.visibleslide1s[e])-f;b.loop&&0>h&&(h=a.slide1s.length-2*a.loopedslide1s+h);b.loop&&h>=a.slide1s.length-2*a.loopedslide1s&&(h=a.slide1s.length-2*a.loopedslide1s-h,h=Math.abs(h));c.push(h)}for(e=0;e<c.length;e++)d[c[e]]&&(d[c[e]].className+=" "+b.paginationVisibleClass);b.loop?d[a.activeLoopIndex].className+=" "+b.paginationActiveClass:d[a.activeIndex].className+=" "+b.paginationActiveClass}else b.loop?d[a.activeLoopIndex].className+=" "+b.paginationActiveClass+" "+b.paginationVisibleClass:
d[a.activeIndex].className+=" "+b.paginationActiveClass+" "+b.paginationVisibleClass}}};a.calcVisibleslide1s=function(c){var d=[],e=0,f=0,g=0;k&&0<a.wrapper1Left&&(c+=a.wrapper1Left);!k&&0<a.wrapper1Top&&(c+=a.wrapper1Top);for(var h=0;h<a.slide1s.length;h++){var e=e+f,f="auto"==b.slide1sPerView?k?a.h.getWidth(a.slide1s[h],!0):a.h.getHeight(a.slide1s[h],!0):p,g=e+f,m=!1;b.visibilityFullFit?(e>=-c&&g<=-c+l&&(m=!0),e<=-c&&g>=-c+l&&(m=!0)):(g>-c&&g<=-c+l&&(m=!0),e>=-c&&e<-c+l&&(m=!0),e<-c&&g>-c+l&&(m=!0));m&&
d.push(a.slide1s[h])}0==d.length&&(d=[a.slide1s[a.activeIndex]]);a.visibleslide1s=d};a.autoPlayIntervalId=void 0;a.startAutoplay=function(){if("undefined"!==typeof a.autoPlayIntervalId)return!1;b.autoplay&&!b.loop&&(a.autoPlayIntervalId=setInterval(function(){a.swipeNext(!0)||a.swipeTo(0)},b.autoplay));b.autoplay&&b.loop&&(a.autoPlayIntervalId=setInterval(function(){a.swipeNext()},b.autoplay));a.callPlugins("onAutoplayStart")};a.stopAutoplay=function(){a.autoPlayIntervalId&&clearInterval(a.autoPlayIntervalId);
a.autoPlayIntervalId=void 0;a.callPlugins("onAutoplayStop")};a.loopCreated=!1;a.removeLoopedslide1s=function(){if(a.loopCreated)for(var b=0;b<a.slide1s.length;b++)!0===a.slide1s[b].getData("looped")&&a.wrapper1.removeChild(a.slide1s[b])};a.createLoop=function(){if(0!=a.slide1s.length){a.loopedslide1s=b.slide1sPerView+b.loopAdditionalslide1s;for(var c="",d="",e=0;e<a.loopedslide1s;e++)c+=a.slide1s[e].outerHTML;for(e=a.slide1s.length-a.loopedslide1s;e<a.slide1s.length;e++)d+=a.slide1s[e].outerHTML;J.innerHTML=d+J.innerHTML+
c;a.loopCreated=!0;a.calcslide1s();for(e=0;e<a.slide1s.length;e++)(e<a.loopedslide1s||e>=a.slide1s.length-a.loopedslide1s)&&a.slide1s[e].setData("looped",!0);a.callPlugins("onCreateLoop")}};a.fixLoop=function(){if(a.activeIndex<a.loopedslide1s){var c=a.slide1s.length-3*a.loopedslide1s+a.activeIndex;a.swipeTo(c,0,!1)}else a.activeIndex>a.slide1s.length-2*b.slide1sPerView&&(c=-a.slide1s.length+a.activeIndex+a.loopedslide1s,a.swipeTo(c,0,!1))};a.loadslide1s=function(){var c="";a.activeLoaderIndex=0;for(var d=b.loader.slide1s,
e=b.loader.loadAllslide1s?d.length:b.slide1sPerView*(1+b.loader.surroundGroups),f=0;f<e;f++)c="outer"==b.loader.slide1sHTMLType?c+d[f]:c+("<"+b.slide1Element+' class="'+b.slide1Class+'" data-swiperindex="'+f+'">'+d[f]+"</"+b.slide1Element+">");a.wrapper1.innerHTML=c;a.calcslide1s(!0);b.loader.loadAllslide1s||a.wrapper1TransitionEnd(a.reloadslide1s,!0)};a.reloadslide1s=function(){var c=b.loader.slide1s,d=parseInt(a.activeslide1().data("swiperindex"),10);if(!(0>d||d>c.length-1)){a.activeLoaderIndex=d;var e=Math.max(0,
d-b.slide1sPerView*b.loader.surroundGroups),f=Math.min(d+b.slide1sPerView*(1+b.loader.surroundGroups)-1,c.length-1);0<d&&(d=-p*(d-e),k?a.setwrapper1Translate(d,0,0):a.setwrapper1Translate(0,d,0),a.setwrapper1Transition(0));if("reload"===b.loader.logic){for(var g=a.wrapper1.innerHTML="",d=e;d<=f;d++)g+="outer"==b.loader.slide1sHTMLType?c[d]:"<"+b.slide1Element+' class="'+b.slide1Class+'" data-swiperindex="'+d+'">'+c[d]+"</"+b.slide1Element+">";a.wrapper1.innerHTML=g}else{for(var g=1E3,h=0,d=0;d<a.slide1s.length;d++){var l=
a.slide1s[d].data("swiperindex");l<e||l>f?a.wrapper1.removeChild(a.slide1s[d]):(g=Math.min(l,g),h=Math.max(l,h))}for(d=e;d<=f;d++)d<g&&(e=document.createElement(b.slide1Element),e.className=b.slide1Class,e.setAttribute("data-swiperindex",d),e.innerHTML=c[d],a.wrapper1.insertBefore(e,a.wrapper1.firstChild)),d>h&&(e=document.createElement(b.slide1Element),e.className=b.slide1Class,e.setAttribute("data-swiperindex",d),e.innerHTML=c[d],a.wrapper1.appendChild(e))}a.reInit(!0)}};a.calcslide1s();0<b.loader.slide1s.length&&
0==a.slide1s.length&&a.loadslide1s();b.loop&&a.createLoop();a.init();n();b.pagination&&b.createPagination&&a.createPagination(!0);b.loop||0<b.initialslide1?a.swipeTo(b.initialslide1,0,!1):a.updateActiveslide1(0);b.autoplay&&a.startAutoplay()}};
Swiper.prototype={plugins:{},wrapper1TransitionEnd:function(f,b){function g(){f(h);h.params.queueEndCallbacks&&(h._queueEndCallbacks=!1);if(!b)for(var v=0;v<t.length;v++)h.h.removeEventListener(n,t[v],g,!1)}var h=this,n=h.wrapper1,t=["webkitTransitionEnd","transitionend","oTransitionEnd","MSTransitionEnd","msTransitionEnd"];if(f)for(var v=0;v<t.length;v++)h.h.addEventListener(n,t[v],g,!1)},getwrapper1Translate:function(f){var b=this.wrapper1,g,h,n=window.WebKitCSSMatrix?new WebKitCSSMatrix(window.getComputedStyle(b,
null).webkitTransform):window.getComputedStyle(b,null).MozTransform||window.getComputedStyle(b,null).OTransform||window.getComputedStyle(b,null).MsTransform||window.getComputedStyle(b,null).msTransform||window.getComputedStyle(b,null).transform||window.getComputedStyle(b,null).getPropertyValue("transform").replace("translate(","matrix(1, 0, 0, 1,");g=n.toString().split(",");this.params.useCSS3Transforms?("x"==f&&(h=16==g.length?parseFloat(g[12]):window.WebKitCSSMatrix?n.m41:parseFloat(g[4])),"y"==
f&&(h=16==g.length?parseFloat(g[13]):window.WebKitCSSMatrix?n.m42:parseFloat(g[5]))):("x"==f&&(h=parseFloat(b.style.left,10)||0),"y"==f&&(h=parseFloat(b.style.top,10)||0));return h||0},setwrapper1Translate:function(f,b,g){var h=this.wrapper1.style;f=f||0;b=b||0;g=g||0;this.params.useCSS3Transforms?this.support.transforms3d?h.webkitTransform=h.MsTransform=h.msTransform=h.MozTransform=h.OTransform=h.transform="translate3d("+f+"px, "+b+"px, "+g+"px)":(h.webkitTransform=h.MsTransform=h.msTransform=h.MozTransform=
h.OTransform=h.transform="translate("+f+"px, "+b+"px)",this.support.transforms||(h.left=f+"px",h.top=b+"px")):(h.left=f+"px",h.top=b+"px");this.callPlugins("onSetwrapper1Transform",{x:f,y:b,z:g})},setwrapper1Transition:function(f){var b=this.wrapper1.style;b.webkitTransitionDuration=b.MsTransitionDuration=b.msTransitionDuration=b.MozTransitionDuration=b.OTransitionDuration=b.transitionDuration=f/1E3+"s";this.callPlugins("onSetwrapper1Transition",{duration:f})},h:{getWidth:function(f,b){var g=window.getComputedStyle(f,
null).getPropertyValue("width"),h=parseFloat(g);if(isNaN(h)||0<g.indexOf("%"))h=f.offsetWidth-parseFloat(window.getComputedStyle(f,null).getPropertyValue("padding-left"))-parseFloat(window.getComputedStyle(f,null).getPropertyValue("padding-right"));b&&(h+=parseFloat(window.getComputedStyle(f,null).getPropertyValue("padding-left"))+parseFloat(window.getComputedStyle(f,null).getPropertyValue("padding-right")));return h},getHeight:function(f,b){if(b)return f.offsetHeight;var g=window.getComputedStyle(f,
null).getPropertyValue("height"),h=parseFloat(g);if(isNaN(h)||0<g.indexOf("%"))h=f.offsetHeight-parseFloat(window.getComputedStyle(f,null).getPropertyValue("padding-top"))-parseFloat(window.getComputedStyle(f,null).getPropertyValue("padding-bottom"));b&&(h+=parseFloat(window.getComputedStyle(f,null).getPropertyValue("padding-top"))+parseFloat(window.getComputedStyle(f,null).getPropertyValue("padding-bottom")));return h},getOffset:function(f){var b=f.getBoundingClientRect(),g=document.body,h=f.clientTop||
g.clientTop||0,g=f.clientLeft||g.clientLeft||0,n=window.pageYOffset||f.scrollTop;f=window.pageXOffset||f.scrollLeft;document.documentElement&&!window.pageYOffset&&(n=document.documentElement.scrollTop,f=document.documentElement.scrollLeft);return{top:b.top+n-h,left:b.left+f-g}},windowWidth:function(){if(window.innerWidth)return window.innerWidth;if(document.documentElement&&document.documentElement.clientWidth)return document.documentElement.clientWidth},windowHeight:function(){if(window.innerHeight)return window.innerHeight;
if(document.documentElement&&document.documentElement.clientHeight)return document.documentElement.clientHeight},windowScroll:function(){if("undefined"!=typeof pageYOffset)return{left:window.pageXOffset,top:window.pageYOffset};if(document.documentElement)return{left:document.documentElement.scrollLeft,top:document.documentElement.scrollTop}},addEventListener:function(f,b,g,h){f.addEventListener?f.addEventListener(b,g,h):f.attachEvent&&f.attachEvent("on"+b,g)},removeEventListener:function(f,b,g,h){f.removeEventListener?
